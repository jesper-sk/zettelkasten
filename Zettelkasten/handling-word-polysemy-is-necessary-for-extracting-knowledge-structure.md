If the goal of my thesis is to automatically create a "WordNet" from a large-text corpus, then is is *obvious* that we'll need to handle word polysemy to receive good output. 
